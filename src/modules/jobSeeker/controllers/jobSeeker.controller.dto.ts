...
class JobSeekerController extends BaseController {
    ...
    private async getJobSeekerById() {
        this.router.get("/v1/job-seekers/:id", async (req: Request, res: Response) => {
    ...
    private async createJobSeeker() {
        this.router.post("/v1/job-seekers", this.mustAuthorized, async (req: Request, res: Response) => {
            ...
            const jobSeeker = await this.jobSeekerService.getJobSeekerById(newJobSeeker);
            if (this.isServiceError(res, jobSeeker)) {
                return;
            }
    ...
    private async updateJobSeeker() {
        this.router.put("/v1/job-seekers", this.mustAuthorized, async (req: Request, res: Response) => {
            ...
            const jobSeeker = await this.jobSeekerService.getJobSeekerById(updatedJobSeeker);
            if(this.isServiceError(res, jobSeeker)) {
                return;
            }
